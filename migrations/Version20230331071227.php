 ...
 */
final class Version20230331071227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tax_supporting_docs ADD tax_year_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tax_supporting_docs ADD CONSTRAINT FK_37201FCD1895EAD FOREIGN KEY (tax_year_id) REFERENCES tax_year (id)');
