 ...
 */
final class Version20210705054932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE default_tennis_player_availability_hours (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, weekday_or_weekend VARCHAR(255) NOT NULL, hour INT DEFAULT NULL, INDEX IDX_869F38CAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
