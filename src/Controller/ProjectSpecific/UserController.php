...
use App\Form\ProjectSpecific\RecruiterEmailsType;
use App\Form\ProjectSpecific\UserType;
use App\Repository\ATS\CmsCopyRepository;
use App\Repository\ProjectSpecific\HealthRepository;
use App\Repository\ProjectSpecific\IntroductionRepository;
use App\Repository\ProjectSpecific\IntroductionSegmentRepository;
use App\Repository\ProjectSpecific\ProspectEmployerRepository;
...
use App\Services\ProjectSpecific\UserIsHouseGuest;
...
class UserController extends AbstractController
{
     ...
     * @Security("is_granted('ROLE_ADMIN')")
     */
    public function indexEditedSinceDowload(UserRepository $userRepository, SettingsRepository $settingsRepository): Response
    {
        $lastDownload = $settingsRepository->find(1)->getLastOutlookDownload();
        return $this->render('user/index.html.twig', [
