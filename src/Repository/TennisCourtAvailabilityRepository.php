...
/**
 * @extends ServiceEntityRepository<TennisCourtAvailability>
 *
...
class TennisCourtAvailabilityRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TennisCourtAvailability $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TennisCourtAvailability $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return TennisCourtAvailability[] Returns an array of TennisCourtAvailability objects
    //  */
    /*
